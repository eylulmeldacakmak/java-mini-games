...
1. **QuizGame**
   - Solve a multiple-choice quiz with scoring.
...
```bash
cd java-mini-games/NumberGuessingGame
```
...
Repeat the steps above for the other games by navigating to their folders.
